...
func assetsServerTlsSnakeoilKey() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/server/tls/snakeoil.key", size: 3294, mode: os.FileMode(420), modTime: time.Unix(1648807325, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
